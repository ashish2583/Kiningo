...
import ShopEat from 'src/pages/Shop/ShopEat/ShopEat';
import ShopEntertainment from 'src/pages/Shop/ShopEntertainment/ShopEntPlaceDetails';
// import ShopEntertainment from 'src/pages/Shop/ShopEntertainment/ShopEntertainment';
import ShopIntertenment from 'src/pages/Shop/ShopIntertenment';
import ShopProduct from 'src/pages/Shop/ShopProduct';

import Talkie from 'src/pages/Talkie/Talkie';
import Finenc from 'src/pages/Talkie/Finenc';
import General from 'src/pages/Talkie/General';
import Movie from 'src/pages/Talkie/Movie';
import Music from 'src/pages/Talkie/Music';
import Search from 'src/pages/Talkie/Search';
import Sport from 'src/pages/Talkie/Sport';
import Statistic from 'src/pages/Talkie/Statistic';
import VideoGame from 'src/pages/Talkie/VideoGame';
import Weather from 'src/pages/Talkie/Weather';
