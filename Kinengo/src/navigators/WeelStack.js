...
import Creation2Fashion from './Creation2Fashion';
...
const WeelStack=(props)=>{
    ...
    return(
           ...
           <Stack.Navigator
            ...
            <Stack.Screen component = {ShopEntertainmentStack} name="ShopEntertainment" />
            <Stack.Screen component = {ShopProductStack} name="ShopProductStack" />
            ...
            <Stack.Screen component = {Creation2Fashion} name="Creation2Fashion" />
            ...
            <Stack.Screen component = {ServiceStack} name="ServiceStack" />
