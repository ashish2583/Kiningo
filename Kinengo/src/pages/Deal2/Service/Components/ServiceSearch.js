...
<View style={{width:'87%',height:55,backgroundColor:'#fff',alignSelf:'center',flexDirection:'row',
   shadowColor: '#000',
      shadowOffset: {
        width: 0,
        height: 3
...
//  elevation: 5,
    ...
    <View style={{width:'14%',height:45,backgroundColor:'transparent',borderRadius:8,right:5,position:'absolute'}}>
        ...
        <Image source={props.searchIcon ? props.searchIcon : require('../../../../assets/service-search-icon.png')} style={{ width: 22, height: 22, alignSelf: 'center'}}></Image>
        </TouchableOpacity>
    </View>
