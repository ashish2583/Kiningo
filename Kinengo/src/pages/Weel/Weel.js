    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        <View style={{ alignSelf: 'center', marginVertical: 30 }}>
          ...
          <Text style={{ textAlign: 'center', fontSize: 24, color: Mycolors.SearchBoxColor, fontWeight: '600' }} onPress={()=>props.navigation.navigate('ShopEat')}>Eat</Text>
          <Text style={{ textAlign: 'center', fontSize: 24, color: Mycolors.SearchBoxColor, fontWeight: '600' }} onPress={()=>props.navigation.navigate('ShopEntertainment')}>Entertainment</Text>
          ...
          <Text style={{ textAlign: 'center', fontSize: 24, color: Mycolors.SearchBoxColor, fontWeight: '600' }} onPress={()=>props.navigation.navigate('Deal2Learning')}>Learning</Text>
          <Text style={{ textAlign: 'center', fontSize: 24, color: Mycolors.SearchBoxColor, fontWeight: '600' }} onPress={()=>props.navigation.navigate('Creation2Fashion')}>Fashion</Text>
        </View>
<View>
