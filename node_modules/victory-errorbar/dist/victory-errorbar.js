...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/line.js");
...
var evaluateProps = function (props) {
  ...
  var style = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateStyle(lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({
    stroke: "black"
  }, props.style), props);
...
var ErrorBar = function (props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(groupComponent, _objectSpread({
    tabIndex: tabIndex,
    "aria-label": ariaLabel
  }, userProps), children);
};
ErrorBar.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_4__.CommonProps.primitiveProps), {}, {
  borderWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object),
  errorX: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().array), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool)]),
  errorY: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().array), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool)]),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
  lineComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
...
ErrorBar.defaultProps = {
  ...
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__.Line, null),
  role: "presentation",
  shapeRendering: "auto"
};
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/collection.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/scale.js");
...
var getData = function (props) {
  ...
  if (props.data) {
    return victory_core__WEBPACK_IMPORTED_MODULE_3__.formatData(props.data, props, accessorTypes);
  }

  var generatedData = props.errorX || props.errorY ? victory_core__WEBPACK_IMPORTED_MODULE_3__.generateData(props) : [];
  return victory_core__WEBPACK_IMPORTED_MODULE_3__.formatData(generatedData, props, accessorTypes);
};

var getDomainFromData = function (props, axis) {
  var minDomain = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMinFromProps(props, axis);
  var maxDomain = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMaxFromProps(props, axis);
  var dataset = getData(props);

  if (dataset.length < 1) {
    return minDomain !== undefined && maxDomain !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomainFromMinMax(minDomain, maxDomain) : undefined;
  }
  ...
  return victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomainFromMinMax(min, max);
};

var getDomain = function (props, axis) {
  return victory_core__WEBPACK_IMPORTED_MODULE_4__.createDomainFunction(getDomainFromData)(props, axis);
...
var formatDataFromDomain = function (datum, domain) {
  var minDomainX = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMinValue(domain.x);
  var maxDomainX = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMaxValue(domain.x);
  var minDomainY = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMinValue(domain.y);
  var maxDomainY = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMaxValue(domain.y);
  var _x = datum._x,
...
var getCalculatedValues = function (props) {
  var defaultStyles = victory_core__WEBPACK_IMPORTED_MODULE_6__.getDefaultStyles(props, "errorbar");
  var style = victory_core__WEBPACK_IMPORTED_MODULE_6__.getStyles(props.style, defaultStyles) || {};
  var data = getData(props);
  var range = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_6__.getRange(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_6__.getRange(props, "y")
  };
  var domain = {
    x: getDomain(props, "x"),
    y: getDomain(props, "y")
  ...
  var scale = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_7__.getBaseScale(props, "x").domain(domain.x).range(props.horizontal ? range.y : range.x),
    y: victory_core__WEBPACK_IMPORTED_MODULE_7__.getBaseScale(props, "y").domain(domain.y).range(props.horizontal ? range.x : range.y)
  };
  var origin = props.polar ? props.origin || victory_core__WEBPACK_IMPORTED_MODULE_6__.getPolarOrigin(props) : undefined;
  return {
    domain: domain,
    data: data,
    scale: scale,
...
var getLabelProps = function (dataProps, text, style) {
  ...
  if (!victory_core__WEBPACK_IMPORTED_MODULE_6__.isTooltip(labelComponent)) {
    return labelProps;
  }

  var tooltipTheme = theme && theme.tooltip || {};
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, labelProps, victory_core__WEBPACK_IMPORTED_MODULE_6__.omit(tooltipTheme, ["style"]));
};

var getBaseProps = function (props, fallbackProps) {
  var modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_6__.modifyProps(props, fallbackProps, "errorbar");
  props = lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, modifiedProps, getCalculatedValues(modifiedProps));
  var _props = props,
  ...
  return data.reduce(function (childProps, datum, index) {
    ...
    var _Helpers$scalePoint = victory_core__WEBPACK_IMPORTED_MODULE_6__.scalePoint(lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, props, {
      scale: scale
    }), datum),
    ...
    if (text !== undefined && text !== null || labels && (events || sharedEvents)) {
      childProps[eventKey].labels = getLabelProps(lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, props, dataProps), text, style);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryErrorBar": () => (/* binding */ VictoryErrorBar)
/* harmony export */ });
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! prop-types */ "../../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-label/victory-label.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-theme/victory-theme.js");
...
/* harmony import */ var _error_bar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./error-bar */ "./error-bar.tsx");
...
VictoryErrorBarBase.defaultTransitions = victory_core__WEBPACK_IMPORTED_MODULE_3__.discreteTransitions();
VictoryErrorBarBase.propTypes = _objectSpread(_objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_4__.CommonProps.baseProps), victory_core__WEBPACK_IMPORTED_MODULE_4__.CommonProps.dataProps), {}, {
  borderWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  errorX: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().func), victory_core__WEBPACK_IMPORTED_MODULE_6__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_6__.integer, victory_core__WEBPACK_IMPORTED_MODULE_6__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string), prop_types__WEBPACK_IMPORTED_MODULE_5___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_5___default().string))]),
  errorY: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().func), victory_core__WEBPACK_IMPORTED_MODULE_6__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_6__.integer, victory_core__WEBPACK_IMPORTED_MODULE_6__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string), prop_types__WEBPACK_IMPORTED_MODULE_5___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_5___default().string))]),
  horizontal: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool)
});
VictoryErrorBarBase.defaultProps = {
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_7__.VictoryContainer, null),
  data: defaultData,
  dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_error_bar__WEBPACK_IMPORTED_MODULE_8__.ErrorBar, null),
  labelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.VictoryLabel, null),
  ...
  sortOrder: "ascending",
  standalone: true,
  theme: victory_core__WEBPACK_IMPORTED_MODULE_10__.VictoryTheme.grayscale
};
VictoryErrorBarBase.getDomain = _helper_methods__WEBPACK_IMPORTED_MODULE_11__.getDomain;
VictoryErrorBarBase.getData = _helper_methods__WEBPACK_IMPORTED_MODULE_11__.getData;

VictoryErrorBarBase.getBaseProps = function (props) {
  return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_11__.getBaseProps)(props, fallbackProps);
};

VictoryErrorBarBase.expectedComponents = ["dataComponent", "labelComponent", "groupComponent", "containerComponent"];
var VictoryErrorBar = (0,victory_core__WEBPACK_IMPORTED_MODULE_12__.addEvents)(VictoryErrorBarBase);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ErrorBar": () => (/* reexport safe */ _error_bar__WEBPACK_IMPORTED_MODULE_1__.ErrorBar),
/* harmony export */   "VictoryErrorBar": () => (/* reexport safe */ _victory_errorbar__WEBPACK_IMPORTED_MODULE_0__.VictoryErrorBar)
/* harmony export */ });
/* harmony import */ var _victory_errorbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./victory-errorbar */ "./victory-errorbar.tsx");
/* harmony import */ var _error_bar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./error-bar */ "./error-bar.tsx");
