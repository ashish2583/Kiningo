...
/* harmony export */   "VictoryBrushLine": () => (/* binding */ VictoryBrushLine)
/* harmony export */ });
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/domain.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/border.js");
...
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-fast-compare */ "../../../node_modules/.pnpm/react-fast-compare@3.2.0/node_modules/react-fast-compare/index.js");
...
var getScale = function (props) {
  ...
  var fallbackScale = victory_core__WEBPACK_IMPORTED_MODULE_6__.getBaseScale(props, dimension);
  var range = victory_core__WEBPACK_IMPORTED_MODULE_7__.getRange(props, dimension);
  var domain = victory_core__WEBPACK_IMPORTED_MODULE_8__.getDomainFromProps(props, dimension) || [0, 1];
...
var withinBound = function (value, bound) {
  return value >= victory_core__WEBPACK_IMPORTED_MODULE_9__.getMinValue(bound) && value <= victory_core__WEBPACK_IMPORTED_MODULE_9__.getMaxValue(bound);
};

var getBrushDomain = function (brushDomain, fullDomain) {
  if (brushDomain) {
    var brushMin = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMinValue(brushDomain);
    var brushMax = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMaxValue(brushDomain);
    var domainMin = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMinValue(fullDomain);
    var domainMax = victory_core__WEBPACK_IMPORTED_MODULE_9__.getMaxValue(fullDomain);
...
var VictoryBrushLine = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderHandles(props) {
      ...
      var style = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, fallbackProps.handleStyle, handleStyle);

      var minDatum = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        handleValue: victory_core__WEBPACK_IMPORTED_MODULE_9__.getMinValue(brushDomain)
      }, datum);

      var maxDatum = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        handleValue: victory_core__WEBPACK_IMPORTED_MODULE_9__.getMaxValue(brushDomain)
      }, datum);

      var minHandleProps = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        key: "".concat(id, "-min"),
        style: victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateStyle(style, {
          datum: minDatum,
          active: activeBrushes.minHandle
        })
      }, handleDimensions.min);

      var maxHandleProps = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        key: "".concat(id, "-max"),
        style: victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateStyle(style, {
          datum: maxDatum,
      ...
      return [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(handleComponent, minHandleProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(handleComponent, maxHandleProps)];
    }
  }, {
    key: "renderBrush",
    value: function renderBrush(props) {
      ...
      var baseStyle = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({}, fallbackProps.brushStyle, brushStyle);

      var style = victory_core__WEBPACK_IMPORTED_MODULE_7__.evaluateStyle(baseStyle, {
        datum: datum,
        active: activeBrushes.brush
      });

      var brushProps = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        style: style
      }, rectDimensions);

      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(brushComponent, brushProps);
    }
  }, {
    key: "renderBrushArea",
    value: function renderBrushArea(props) {
      ...
      var baseStyle = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        cursor: cursor
      ...
      var brushAreaProps = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        style: style
      }, rectDimensions);

      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(brushAreaComponent, brushAreaProps);
    }
  }, {
    key: "renderLine",
    value: function renderLine(props) {
      var filteredProps = lodash_pick__WEBPACK_IMPORTED_MODULE_0___default()(props, ["x1", "x2", "y1", "y2", "datum", "scale", "active", "style"]);

      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(props.lineComponent, filteredProps);
    }
  }, {
    key: "render",
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("g", this.props.events, this.renderLine(this.props), this.renderBrushArea(this.props), this.renderBrush(this.props), this.renderHandles(this.props));
    }
  }]);
...
VictoryBrushLine.propTypes = {
  allowDrag: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().bool),
  allowDraw: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().bool),
  allowResize: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().bool),
  brushAreaComponent: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().element),
  brushAreaStyle: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().object),
  brushAreaWidth: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().number),
  brushComponent: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().element),
  brushDimension: prop_types__WEBPACK_IMPORTED_MODULE_10___default().oneOf(["x", "y"]),
  brushDomain: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().array),
  brushStyle: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().object),
  brushWidth: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().number),
  className: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().string),
  dimension: prop_types__WEBPACK_IMPORTED_MODULE_10___default().oneOf(["x", "y"]),
  disable: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().bool),
  events: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().object),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().element),
  handleComponent: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().element),
  handleStyle: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().object),
  handleWidth: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().number),
  id: prop_types__WEBPACK_IMPORTED_MODULE_10___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_10___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_10___default().string)]),
  lineComponent: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().element),
  name: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().string),
  onBrushDomainChange: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().func),
  scale: (prop_types__WEBPACK_IMPORTED_MODULE_10___default().object),
...
VictoryBrushLine.defaultProps = {
  ...
  allowDraw: true,
  allowResize: true,
  brushAreaComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__.Border, null),
  brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__.Border, null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("g", null),
  handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__.Border, null),
  handleWidth: 10,
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_12__.LineSegment, null),
  width: 10
};
  ...
  return props.disable ? undefined : [{
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        var position = victory_core__WEBPACK_IMPORTED_MODULE_13__.getSVGEventCoordinates(evt, parentSVG)[dimension];
        ...
        var activeBrushes = {
          ...
          brush: withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_5___default()(fullDomain, currentDomain),
      ...
      onMouseDown: function (evt, targetProps) {
        ...
        } else if (withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_5___default()(fullDomain, currentDomain)) {
      ...
      onMouseMove: function (evt, targetProps) {
        ...
        var activeBrushes = {
          brushArea: !targetProps.brushDomain,
          brush: withinBound(position, initialRange) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_5___default()(fullDomain, domain),
          minHandle: activeHandle === "min" || activeHandle === "both",
        ...
        if (allowDrag && isPanning) {
          ...
          if (lodash_isFunction__WEBPACK_IMPORTED_MODULE_1___default()(onBrushDomainChange)) {
            onBrushDomainChange(currentDomain, lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, mutatedProps, targetProps));
          }
          ...
          if (lodash_isFunction__WEBPACK_IMPORTED_MODULE_1___default()(onBrushDomainChange)) {
            onBrushDomainChange(_currentDomain, lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, _mutatedProps, targetProps));
          }
      ...
      onMouseUp: function (evt, targetProps) {
        ...
        if (allowResize && lodash_isFunction__WEBPACK_IMPORTED_MODULE_1___default()(onBrushDomainChange)) {
          onBrushDomainChange(brushDomain, lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, mutatedProps, targetProps));
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryBrushLine": () => (/* reexport safe */ _victory_brush_line__WEBPACK_IMPORTED_MODULE_0__.VictoryBrushLine)
/* harmony export */ });
/* harmony import */ var _victory_brush_line__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./victory-brush-line */ "./victory-brush-line.tsx");
