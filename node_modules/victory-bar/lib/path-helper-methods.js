...
var getHorizontalBarPoints = function (position, sign, cr) {
  ...
  var getHalfPoints = function (side) {
    ...
    if (hasIntersection) {
      var leftCenter = (0, _geometryHelperMethods.point)(x0 + cr["".concat(side, "Left")], y - signL * cr["".concat(side, "Left")]);
      var leftCircle = (0, _geometryHelperMethods.circle)(leftCenter, cr["".concat(side, "Left")]);
      var rightCenter = (0, _geometryHelperMethods.point)(x1 - cr["".concat(side, "Right")], y - signL * cr["".concat(side, "Right")]);
      var rightCircle = (0, _geometryHelperMethods.circle)(rightCenter, cr["".concat(side, "Right")]);
