...
var getScale = function (props) {
  var axis = victory_core__WEBPACK_IMPORTED_MODULE_2__.getAxis(props);
  var currentAxis = getCurrentAxis(props, axis);
  var scale = victory_core__WEBPACK_IMPORTED_MODULE_3__.getBaseScale(props, axis);
  var propsDomain = props.domain && props.domain[axis];
  var domain = propsDomain || victory_core__WEBPACK_IMPORTED_MODULE_2__.getDomain(props) || scale.domain();
  scale.range(victory_core__WEBPACK_IMPORTED_MODULE_4__.getRange(props, currentAxis));
  scale.domain(domain);
  return scale;
};
...
var getEvaluatedStyles = function (style, props) {
  return {
    tickStyle: victory_core__WEBPACK_IMPORTED_MODULE_4__.evaluateStyle(style.ticks, props),
    labelStyle: victory_core__WEBPACK_IMPORTED_MODULE_4__.evaluateStyle(style.tickLabels, props),
    gridStyle: victory_core__WEBPACK_IMPORTED_MODULE_4__.evaluateStyle(style.grid, props)
  };
};
...
var getLabelPadding = function (props, style) {
  ...
  var isVertical = victory_core__WEBPACK_IMPORTED_MODULE_2__.isVertical(props); // TODO: magic numbers
...
var getStandaloneOffset = function (props, calculatedValues) {
  ...
  var tickSizes = ticks.map(function (data, index) {
    ...
    var tickStyle = victory_core__WEBPACK_IMPORTED_MODULE_4__.evaluateStyle(style.ticks, lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, sharedProps, {
      tick: tick,
      index: index
    }));
...
var getTransform = function (props, calculatedValues, offset) {
  var orientation = calculatedValues.orientation,
      axis = calculatedValues.axis;
  var axisValue = victory_core__WEBPACK_IMPORTED_MODULE_2__.getAxisValue(props, axis);
  return {
    top: {
      x: 0,
...
var getCalculatedValues = function (props) {
  ...
  var padding = victory_core__WEBPACK_IMPORTED_MODULE_4__.getPadding(props);
  var labelPadding = getLabelPadding(props, style);
  var stringTicks = victory_core__WEBPACK_IMPORTED_MODULE_2__.stringTicks(props) ? props.tickValues : undefined;
  var axis = victory_core__WEBPACK_IMPORTED_MODULE_2__.getAxis(props);
  var axisDomain = victory_core__WEBPACK_IMPORTED_MODULE_2__.getDomain(props);
  ...
  var ticks = victory_core__WEBPACK_IMPORTED_MODULE_2__.getTicks(props, axisScale, crossAxis);
  var tickFormat = victory_core__WEBPACK_IMPORTED_MODULE_2__.getTickFormat(props, axisScale);
  var range = {
  ...
  var scale = {
    x: props.domain && props.domain.x ? victory_core__WEBPACK_IMPORTED_MODULE_3__.getBaseScale(props, "x").domain(props.domain.x).range(props.horizontal ? range.y : range.x) : xAxisScale,
    y: props.domain && props.domain.y ? victory_core__WEBPACK_IMPORTED_MODULE_3__.getBaseScale(props, "y").domain(props.domain.y).range(props.horizontal ? range.x : range.y) : yAxisScale
  };
  var origin = domain.x && domain.y ? victory_core__WEBPACK_IMPORTED_MODULE_2__.getOrigin(domain) : undefined;
  var originSign = origin ? {
    x: victory_core__WEBPACK_IMPORTED_MODULE_2__.getOriginSign(origin.x, domain.x),
    y: victory_core__WEBPACK_IMPORTED_MODULE_2__.getOriginSign(origin.y, domain.y)
  } : undefined;
  ...
  var isVertical = victory_core__WEBPACK_IMPORTED_MODULE_2__.isVertical(Object.assign({}, props, {
...
var getBaseProps = function (props, fallbackProps) {
  props = victory_core__WEBPACK_IMPORTED_MODULE_2__.modifyProps(props, fallbackProps);
  ...
  var initialChildProps = {
    parent: lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({
      style: style.parent,
      ticks: ticks,
  ...
  var gridProps = {
    dimension: otherAxis,
    range: _defineProperty({}, otherAxis, victory_core__WEBPACK_IMPORTED_MODULE_4__.getRange(props, otherAxis)),
  ...
  return ticks.reduce(function (childProps, tickValue, index) {
    ...
    var styles = getEvaluatedStyles(style, lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, sharedProps, {
      tick: tick,
      tickValue: tickValue,
      index: index,
      text: text
    ...
    childProps[index] = {
      axis: lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({
        dimension: axis
      }, sharedProps, axisProps),
      axisLabel: lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, sharedProps, axisLabelProps),
      ticks: lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, sharedProps, getTickProps(tickLayout, styles.tickStyle, tickValue)),
      tickLabels: lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, sharedProps, getTickLabelProps(tickLayout, styles.labelStyle, anchors, tickValue, text)),
      grid: lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, sharedProps, gridProps, getGridProps(gridLayout, styles.gridStyle, tickValue))
    };
    return childProps;
  }, initialChildProps);
};
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/textsize.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/user-props.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/prop-types.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-label/victory-label.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/add-events.js");
/* harmony import */ var _helper_methods__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./helper-methods */ "./helper-methods.tsx");
  ...
  _createClass(VictoryAxisBase, [{
    ...
    value: function renderGridAndTicks(props) {
      ...
      return this.dataKeys.map(function (key, index) {
        ...
        var BaseTickComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(tickComponent, tickProps);
        ...
        var BaseGridComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(gridComponent, gridProps);
        ...
        var TickLabel = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(tickLabelComponent, tickLabelProps);
        var children = [GridComponent, TickComponent, TickLabel].filter(Boolean);
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(props.groupComponent, {
    ...
    value: function fixLabelOverlap(gridAndTicks, props) {
      var isVertical = victory_core__WEBPACK_IMPORTED_MODULE_3__.isVertical(props);
      ...
      var paddingToObject = function (padding) {
        return typeof padding === "object" ? lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, {
          top: 0,
          right: 0,
          bottom: 0,
          left: 0
      ...
      var labelsSumSize = labels.reduce(function (sum, label) {
        ...
        var labelSize = victory_core__WEBPACK_IMPORTED_MODULE_4__.approximateTextSize(label.text, {
          angle: label.angle,
    ...
    value: function render() {
      ...
      var userProps = victory_core__WEBPACK_IMPORTED_MODULE_5__.getSafeUserProps(this.props);
      ...
      var container = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(props.containerComponent, userProps);
      return props.standalone ? this.renderContainer(container, children) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(props.groupComponent, userProps, children);
    }
  }]);
...
VictoryAxisBase.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__.CommonProps.baseProps), {}, {
  axisComponent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().element),
  axisLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().element),
  axisValue: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_7___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_7___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object)]),
  categories: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_7___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_7___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
    x: prop_types__WEBPACK_IMPORTED_MODULE_7___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_7___default().string)),
    y: prop_types__WEBPACK_IMPORTED_MODULE_7___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_7___default().string))
  })]),
  crossAxis: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().bool),
  dependentAxis: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().bool),
  events: prop_types__WEBPACK_IMPORTED_MODULE_7___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
    target: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOf(["axis", "axisLabel", "grid", "ticks", "tickLabels"]),
    eventKey: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_7___default().array), victory_core__WEBPACK_IMPORTED_MODULE_8__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_8__.integer, victory_core__WEBPACK_IMPORTED_MODULE_8__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_7___default().string)]),
    eventHandlers: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object)
  })),
  fixLabelOverlap: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().bool),
  gridComponent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().element),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().element),
  invertAxis: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().bool),
  label: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().any),
  offsetX: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
  offsetY: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
  orientation: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOf(["top", "bottom", "left", "right"]),
  origin: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
    x: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number),
    y: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().number)
  }),
  stringMap: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
  style: prop_types__WEBPACK_IMPORTED_MODULE_7___default().shape({
    parent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
    axis: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
    axisLabel: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
    grid: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
    ticks: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object),
    tickLabels: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().object)
  }),
  tickComponent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().element),
  tickCount: victory_core__WEBPACK_IMPORTED_MODULE_8__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_8__.integer, victory_core__WEBPACK_IMPORTED_MODULE_8__.greaterThanZero]),
  tickFormat: prop_types__WEBPACK_IMPORTED_MODULE_7___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_7___default().func), victory_core__WEBPACK_IMPORTED_MODULE_8__.homogeneousArray]),
  tickLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().element),
  tickValues: victory_core__WEBPACK_IMPORTED_MODULE_8__.homogeneousArray
});
VictoryAxisBase.defaultProps = {
  axisComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.LineSegment, null),
  axisLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_10__.VictoryLabel, null),
  tickLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_10__.VictoryLabel, null),
  tickComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.LineSegment, null),
  gridComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.LineSegment, null),
  standalone: true,
  theme: victory_core__WEBPACK_IMPORTED_MODULE_11__.VictoryTheme.grayscale,
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_12__.VictoryContainer, null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("g", {
    role: "presentation"
  }),
  fixLabelOverlap: false
};
VictoryAxisBase.getDomain = victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomain;
VictoryAxisBase.getAxis = victory_core__WEBPACK_IMPORTED_MODULE_3__.getAxis;

VictoryAxisBase.getStyles = function (props) {
  return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_13__.getStyles)(props);
};

VictoryAxisBase.getBaseProps = function (props) {
  return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_13__.getBaseProps)(props, fallbackProps);
};
...
var VictoryAxis = (0,victory_core__WEBPACK_IMPORTED_MODULE_14__.addEvents)(VictoryAxisBase, options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryAxis": () => (/* reexport safe */ _victory_axis__WEBPACK_IMPORTED_MODULE_0__.VictoryAxis)
/* harmony export */ });
