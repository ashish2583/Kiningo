...
/* harmony import */ var victory_bar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! victory-bar */ "../../victory-bar/es/bar-helper-methods.js");
/* harmony import */ var victory_bar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! victory-bar */ "../../victory-bar/es/path-helper-methods.js");
/* harmony import */ var _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./hooks/use-canvas-context */ "./hooks/use-canvas-context.js");
...
var evaluateProps = function (props) {
   ...
   * 3) `cornerRadius`
   */
  var style = (0,victory_bar__WEBPACK_IMPORTED_MODULE_2__.getStyle)(props.style, props);
  var barWidth = (0,victory_bar__WEBPACK_IMPORTED_MODULE_2__.getBarWidth)(props.barWidth, lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
    style: style
  }));
  var cornerRadius = (0,victory_bar__WEBPACK_IMPORTED_MODULE_2__.getCornerRadius)(props.cornerRadius, lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
    style: style,
    barWidth: barWidth
  }));
...
var CanvasBar = function (initialProps) {
  var _useCanvasContext = (0,_hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_3__.useCanvasContext)(),
  ...
  var polar = props.polar,
      ...
      origin = props.origin;
  var path2d = react__WEBPACK_IMPORTED_MODULE_1___default().useMemo(function () {
    var p = polar ? (0,victory_bar__WEBPACK_IMPORTED_MODULE_4__.getPolarBarPath)(props, cornerRadius) : (0,victory_bar__WEBPACK_IMPORTED_MODULE_4__.getBarPath)(props, barWidth, cornerRadius);
    return new Path2D(p);
  }, [polar, barWidth, cornerRadius, props]);
  var previousPath = usePreviousValue(path2d);
  var draw = react__WEBPACK_IMPORTED_MODULE_1___default().useCallback(function (ctx, path) {
  ...
  var clearPreviousPath = react__WEBPACK_IMPORTED_MODULE_1___default().useCallback(function (ctx) {
    if (previousPath) {
...
CanvasBar.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.CommonProps.primitiveProps), {}, {
  alignment: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOf(["start", "middle", "end"]),
  barRatio: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number),
  barWidth: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  cornerRadius: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func), prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    top: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
    topLeft: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
    topRight: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
    bottom: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
    bottomLeft: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
    bottomRight: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)])
  })]),
  ...
  y0: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number)
});
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/line-helpers.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/common-props.js");
/* harmony import */ var _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hooks/use-canvas-context */ "./hooks/use-canvas-context.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var CanvasCurve = function (props) {
  var _useCanvasContext = (0,_hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_1__.useCanvasContext)(),
      canvasRef = _useCanvasContext.canvasRef,
  ...
  var draw = react__WEBPACK_IMPORTED_MODULE_0___default().useCallback(function (ctx) {
    var line = victory_core__WEBPACK_IMPORTED_MODULE_2__.getLineFunction(props);
...
CanvasCurve.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_3__.CommonProps.primitiveProps), {}, {
  interpolation: prop_types__WEBPACK_IMPORTED_MODULE_4___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_4___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_4___default().func)]),
  openCurve: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().bool),
  origin: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().object),
...
var CanvasGroup = function (props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_1__.CanvasContext.Provider, {
    value: {
      canvasRef: canvasRef,
      clear: clear,
      clip: clip
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("foreignObject", {
    width: width,
    height: height,
    x: 0,
    y: 0
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! prop-types */ "../../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/point-path-helpers.js");
...
var getPath = function (props) {
  ...
  var pathFunctions = {
    circle: victory_core__WEBPACK_IMPORTED_MODULE_2__.circle,
    square: victory_core__WEBPACK_IMPORTED_MODULE_2__.square,
    diamond: victory_core__WEBPACK_IMPORTED_MODULE_2__.diamond,
    triangleDown: victory_core__WEBPACK_IMPORTED_MODULE_2__.triangleDown,
    triangleUp: victory_core__WEBPACK_IMPORTED_MODULE_2__.triangleUp,
    plus: victory_core__WEBPACK_IMPORTED_MODULE_2__.plus,
    minus: victory_core__WEBPACK_IMPORTED_MODULE_2__.minus,
    star: victory_core__WEBPACK_IMPORTED_MODULE_2__.star,
    cross: victory_core__WEBPACK_IMPORTED_MODULE_2__.cross
  };
...
var evaluateProps = function (props) {
   ...
   * `symbol`
   */
  var size = victory_core__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.size, props);
  var style = victory_core__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(props.style, props);
  var symbol = victory_core__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.symbol, props);
  return lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
    size: size,
    style: style,
    symbol: symbol
...
CanvasPoint.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.CommonProps.primitiveProps), {}, {
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
...
var CanvasContext = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createContext();
...
//# sourceMappingURL=bar-helper-methods.js.map
...
//# sourceMappingURL=geometry-helper-methods.js.map
...
/* harmony import */ var _geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./geometry-helper-methods */ "../../victory-bar/es/geometry-helper-methods.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var getVerticalBarPoints = function (position, sign, cr) {
  ...
  var getHalfPoints = function (side) {
    ...
    if (hasIntersection) {
      var topCenter = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.point)(x + signL * cr["top".concat(side)], y1 + sign * cr["top".concat(side)]);
      var topCircle = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.circle)(topCenter, cr["top".concat(side)]);
      var bottomCenter = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.point)(x + signL * cr["bottom".concat(side)], y0 - sign * cr["bottom".concat(side)]);
      var bottomCircle = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.circle)(bottomCenter, cr["bottom".concat(side)]);
...
var getHorizontalBarPoints = function (position, sign, cr) {
  ...
  var getHalfPoints = function (side) {
    ...
    if (hasIntersection) {
      var leftCenter = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.point)(x0 + cr["".concat(side, "Left")], y - signL * cr["".concat(side, "Left")]);
      var leftCircle = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.circle)(leftCenter, cr["".concat(side, "Left")]);
      var rightCenter = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.point)(x1 - cr["".concat(side, "Right")], y - signL * cr["".concat(side, "Right")]);
      var rightCircle = (0,_geometry_helper_methods__WEBPACK_IMPORTED_MODULE_1__.circle)(rightCenter, cr["".concat(side, "Right")]);
...
var getVerticalPolarBarPath = function (props, cornerRadius) {
  ...
  var getPath = function (edge) {
    var pathFunction = victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_0__.arc().innerRadius(r1).outerRadius(r2).startAngle(transformAngle(start)).endAngle(transformAngle(end)).cornerRadius(cornerRadius[edge]);
    return pathFunction();
  };
...
//# sourceMappingURL=path-helper-methods.js.map
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getInterpolationFunction": () => (/* binding */ getInterpolationFunction),
...
/* harmony export */   "symbolX": () => (/* reexport safe */ _symbol_x_js__WEBPACK_IMPORTED_MODULE_21__["default"]),
