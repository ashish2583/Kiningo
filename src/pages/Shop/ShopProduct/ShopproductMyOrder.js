...
{press ?
<Text style={{color:Mycolors.Black,fontSize:13,textDecorationLine:'underline'}}>View Breakup Amount</Text>
...

{
      upData.map((item,index)=> {
        return(
          ...
          <Text style={{color:Mycolors.ORANGE,fontWeight:'400',fontSize:12,marginTop:5}}>#KIN876549</Text>
          <View style={{paddingHorizontal:10,justifyContent:'center',borderRadius:10,backgroundColor:'rgba(100,214,100,0.1)',borderColor:Mycolors.GrayColor,borderWidth:0.2}}>
          <Text style={{color:Mycolors.GREEN,fontSize:11,textAlign:'center',lineHeight:22}}>Yet to Pickup</Text>
          </View>
         
          </View>
          
          <Text style={{color:Mycolors.Black,fontWeight:'600',fontSize:12,marginTop:15}}>Pickup Date and time</Text>
          <Text style={{color:Mycolors.GrayColor,fontSize:11,marginTop:4}}>22 July 2022,11:00 AM</Text>
          
          {flatliistDesign(require('../../../assets/intel_motherboard.png'),'Intel 3rd Gen MotherBoard','','$140.00',()=>{Alert.alert('Add Pressed')},()=>{})}
          ...
          titlecolor={Mycolors.ORANGE} backgroundColor={'transparent'} marginVertical={0} borderColor={Mycolors.RED} borderWidth={0.2}/>
          
          <MyButtons title={item.title=='Dining' ? "Cancel order" : "Submit Review"} height={45} width={'47%'} borderRadius={5} alignSelf="center" press={()=>{
          ...
          titlecolor={item.title=='Dining' ? Mycolors.RED: '#000'} backgroundColor={'transparent'} marginVertical={0} borderColor={Mycolors.Black} borderWidth={0.2}/>
          </View>
          
          <View style={{flexDirection:'row'}}>
          <Text style={{color:Mycolors.Black,fontWeight:'400',fontSize:12,marginTop:9}} >Order date and time:</Text>
